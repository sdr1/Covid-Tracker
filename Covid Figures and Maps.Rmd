...
```{r ratio, echo = F, warning = F,cache = F, message = F, fig.width = 11, fig.height = 8.5}
covid_tracking_data %>% 
  filter(State %in% state.abb) %>%
  mutate( Day = lubridate::yday(Date),
          Week =  lubridate::week(Date),
...
```{r icu, echo = F, warning = F,cache = F, message = F, fig.width = 11, fig.height = 8.5}
covid_tracking_data %>% 
  filter(State %in% state.abb) %>%
  mutate( Day = lubridate::yday(Date),
          Week =  lubridate::week(Date)) %>%
...
```{r vent, echo = F, warning = F,cache = F, message = F, fig.width = 11, fig.height = 8.5}
covid_tracking_data %>% 
  filter(State %in% state.abb) %>%
  mutate( Day = lubridate::yday(Date),
          Week =  lubridate::week(Date)) %>%
